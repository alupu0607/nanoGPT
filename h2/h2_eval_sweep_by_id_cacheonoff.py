...
RUN_IDS = [
    ...
    # frozen baseline
    "258t5o90",  # L=0, m=1, cache off

    # Add cache-on IDs here, for example:
    # "abcdefgh",
]
...
print("\n" + "=" * 104)
print("H2 EXACT-RUN EVAL SUMMARY")
print("=" * 104)
print(
...
eval_run = wandb.init(
    project=PROJECT,
    name=f"h2-eval-by-id-cacheonoff-{timestamp}",
    job_type="eval",
)
wandb.log({
...
summary_path = "/kaggle/working/h2_eval_sweep_by_id_cacheonoff.json"
